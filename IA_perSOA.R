calculate_auc_img_sbj_word_perSOA <- function(img_df, other_image_dfs, target_img_id, target_word, target_subject_index, target_soa, output_plot = FALSE, include_confidence = FALSE) {
